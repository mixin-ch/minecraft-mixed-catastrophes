...
public class CauseStalkerCommand implements CommandExecutor {
    private final MixedCatastrophesPlugin plugin;
    private final String commandName;

    public CauseStalkerCommand(MixedCatastrophesPlugin plugin, String commandName) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.GREEN + "Stalkers caused.");
        return true;
    }
}
