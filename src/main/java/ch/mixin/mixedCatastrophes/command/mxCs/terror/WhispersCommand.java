...
public class WhispersCommand extends SubCommand {
    public WhispersCommand(MixedCatastrophesManagerAccessor mixedCatastrophesManagerAccessor) {
    ...
    public void execute(CommandSender sender, List<String> arguments) {
        ...
        mixedCatastrophesManagerAccessor.getRootCatastropheManager().getPersonalCatastropheManager().getTerrorCatastropheManager().triggerHorrificWhispers(player);
